...
class WarSoundyAudioPlaylistMetaBox
{
    ...
    public function render_meta_box( $post )
    {
        ...
        $enable_soundtrack_download  = get_post_meta( $this->post_id, 'war_sdy_pl_enable_soundtrack_download', true );
        $enable_soundtrack_download  = $enable_soundtrack_download ? $enable_soundtrack_download : 'default';
    ...
    public function save_post_data( $post_id )
    {
        ...
        update_post_meta( $post_id,
            ...
            $_POST[ 'war_sdy_pl_enable_soundtrack_download' ] );
