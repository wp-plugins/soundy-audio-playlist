<div class="wrap">
	...
	<script>
        ...
        sdy_pl_artist_label = '<?php echo $this->playlist_column_names_titles[ "artist" ]; ?>';
	...
	<div id="war_sdy_pl_tabs">
	    <ul>
            ...
            <li><a id="war_sdy_pl_tab_label_responsive"     href="#war_sdy_pl_tab_panel_responsive">Response</a></li>
            <li><a id="war_sdy_pl_tab_label_tags"           href="#war_sdy_pl_tab_panel_tags">Tags</a></li>
	    </ul>
        <div id="war_sdy_pl_tab_panel_general">
            <?php $this->do_settings_section( 'sdy_pl', 'war_sdy_pl_settings_section_general' ); ?>
        </div>
