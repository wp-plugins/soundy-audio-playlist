...
<script>
    ...
    sdy_pl_artist_label = '<?php echo $this->sdy_pl->playlist_column_names_titles[ "artist" ]; ?>';
...
<div id="war_sdy_pl_tabs">
  ...
  <div id="war_sdy_pl_tab_panel_general">
      ...
      <table class="form-table war_sdy_pl_general war_sdy_pl_form_table">
          ...
          <tr>
              <th>
                  <label for="war_sdy_pl_enable_soundtrack_download">Enable Soundtrack Download</label>
              </th>
              <td>
                  <input type="radio"
                         id="war_sdy_pl_enable_soundtrack_download_default"
                         name="war_sdy_pl_enable_soundtrack_download"
                         value="default" <?php echo ( $enable_soundtrack_download == 'default' ? 'checked' : '' ); ?>/>
                  <label for="war_sdy_pl_enable_soundtrack_download_default" style="margin-right: 1em;">Default</label>

                  <input type="radio"
                         id="war_sdy_pl_enable_soundtrack_download_yes"
                         name="war_sdy_pl_enable_soundtrack_download"
                         value="yes" <?php echo ( $enable_soundtrack_download == 'yes' ? 'checked' : '' ); ?>/>
                  <label for="war_sdy_pl_enable_soundtrack_download_yes" style="margin-right: 1em;">Yes</label>

                  <input type="radio"
                         id="war_sdy_pl_enable_soundtrack_download_no"
                         name="war_sdy_pl_enable_soundtrack_download"
                         value="no" <?php echo ( $enable_soundtrack_download == 'no' ? 'checked' : '' ); ?>/>
                  <label for="war_sdy_pl_enable_soundtrack_download_no" style="margin-right: 1em;">No</label>
                  <p class="war_comment">If Soundtrack Download is enabled, users will be able to download current soundtrack by right-clicking on soundtrack title in playlist header and by choosing "Save Link As..." command in appearing context menu.</p>
              </td>
          </tr>
      </table>
  </div>
