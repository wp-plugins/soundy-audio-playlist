            ...
            '<div class="war_sdy_pl_playlist_outer_box">' .
                ...
                '<ul class="war_sdy_pl_playlist">' .
                    '<li class="war_sdy_pl_playlist_columns_caption_row">' .
                        ...
                        '<div class="war_soundtrack_title">' . $this->sdy_pl->playlist_column_names_titles[ 'title' ] . '</div>' .
                        '<div class="war_soundtrack_artist">' . $this->sdy_pl->playlist_column_names_titles[ 'artist' ] . '</div>' .
                        '<div class="war_soundtrack_composer">' . $this->sdy_pl->playlist_column_names_titles[ 'composer' ] . '</div>' .
                        '<div class="war_soundtrack_time">' . $this->sdy_pl->playlist_column_names_titles[ 'time' ] . '</div>' .
                        '<div class="war_soundtrack_id">' . $this->sdy_pl->playlist_column_names_titles[ 'id' ] . '</div>' .
                    '</li>' .
                '</ul>' .
