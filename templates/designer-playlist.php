            ...
            <div class="war_sdy_pl_designer_preview_playlist_outer_box">
                ...
                <ul class="war_sdy_pl_designer_preview_playlist">
                    <li class="war_sdy_pl_designer_preview_playlist_columns_caption_row" >
                        ...
                        <div class="war_designer_preview_soundtrack_title"><?php echo $this->sdy_pl->playlist_column_names_titles[ 'artist' ]; ?></div>
                        <div class="war_designer_preview_soundtrack_time"><?php echo $this->sdy_pl->playlist_column_names_titles[ 'time' ]; ?></div>
                        <div class="war_designer_preview_soundtrack_composer"><?php echo $this->sdy_pl->playlist_column_names_titles[ 'composer' ]; ?></div>
                    </li>
                </ul>
