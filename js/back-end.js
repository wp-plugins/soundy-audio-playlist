...
WarSoundyAudioPlaylistAdmin.prototype.initSettingsTabs = function( args )
{
	...
	_this.bindMediaUploader( 'war_sdy_pl_audio_file_url',   'war_sdy_pl_audio_library_button', 'audio' );
...
WarSoundyAudioPlaylistAdmin.prototype.removeSkimLinks = function()
{
    ...
    _this.removeSkimLinksInList( '#war_sdy_pl_back_end_playlist' );
}

WarSoundyAudioPlaylistAdmin.prototype.removeSkimLinksInList = function( selector )
{
    var _this = this;

    var jquery_soundtracks_list = jQuery( selector );
    ...
    jQuery( '#' + button_name ).click( function( event )
    {
        ...
        custom_uploader.on( 'select',
            function()
            {
                ...
                jq.val( url );
                jq.change();
                jQuery( '#' + field_name ).val( attachment.url );
            } );
...
WarSoundyAudioPlaylistAdmin.prototype.initSoundtrackDefault = function()
{
	...
	var jquery_button_default      = jQuery( '#war_sdy_pl_button_soundtrack_default' );
	var jquery_soundtracks_list    = jQuery( '#war_sdy_pl_back_end_playlist' );
	...
	jquery_button_default.click( function()
	{
		...
		_this.backupSoundtracks();
        _this.removeSkimLinksInList( '#war_sdy_pl_soundtracks_default' );
