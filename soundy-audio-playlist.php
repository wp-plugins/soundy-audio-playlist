...
Copyright 2015 Bertrand du Couédic  (email: bducouedic@webartisan.ch)
...
class WarSoundyAudioPlaylist
{
	...
	public function admin_scripts( $hook )
	{
		...
		wp_register_script( 'sdy_pl-back-end', $this->plugin_url . '/js/back-end.js', array( 'jquery' ) );
	...
	{
        $this->add_settings_section_general();
    ...
    public function add_settings_section_general()
    {
        add_settings_section(
            'war_sdy_pl_settings_section_general',
            'General',
            array( $this, 'display_settings_section_general' ),
            'sdy_pl'
        );

        register_setting( 'war_sdy_pl', 'war_sdy_pl_enable_soundtrack_download' );
        add_settings_field(
            'war_sdy_pl_enable_soundtrack_download',
            'Enable Soundtrack Download',
            array( $this, 'add_settings_field_enable_soundtrack_download' ),
            'sdy_pl',
            'war_sdy_pl_settings_section_general'
        );
    }
    ...
    public function display_settings_section_general()
    {
        echo '';
    }
    ...
    public function add_settings_field_enable_soundtrack_download( $args )
    {
        $enable_soundtrack_download = get_option( 'war_sdy_pl_enable_soundtrack_download' );
        if( ! $enable_soundtrack_download ) $enable_soundtrack_download = 'no';
        ?>
            <script>
                ...
                (
                    function()
                    {
                        var jquery_tr = jQuery( '#war_sdy_pl_enable_soundtrack_download_yes' ).parent().parent();
            ...
            <input type="radio"
                   id="war_sdy_pl_enable_soundtrack_download_yes"
                   name="war_sdy_pl_enable_soundtrack_download"
                   value="yes"
                   style="margin: 5px 0 5px 0;" <?php echo ( $enable_soundtrack_download == 'yes' ? 'checked' : '' ); ?>/>
            <label for="war_sdy_pl_enable_soundtrack_download_yes"
                   style="margin-top: 0;">Yes</label>
            <input type="radio"
                   id="war_sdy_pl_enable_soundtrack_download_no"
                   name="war_sdy_pl_enable_soundtrack_download"
                   value="no"
                   style="margin: 5px 0 5px 15px;" <?php echo ( $enable_soundtrack_download == 'no' ? 'checked' : '' ); ?>/>
            <label for="war_sdy_pl_enable_soundtrack_download_no"
                   style="margin-top: 0;">No</label>
            <p class="war_comment">If "Yes", users will be able to download current soundtrack by right-clicking on soundtrack title in playlist header and by choosing "Save Link As..." command in appearing context menu.</p>
        <?php
    }
	...
	public function add_field_audio_file_URL( $is_meta_box ) 
	{
		...
		<div style="margin-top: 5px;">
			...
			<div id="war_sdy_pl_field_container_media_library" 
			     class="war_sdy_pl_label_field_container">
		    <button id="war_sdy_pl_audio_library_button"
		            type="button" 
		...
		<div style="margin-top: 5px;">
			...
			<div class="war_sdy_pl_label_field_container">
				<span class="war_sdy_pl_label"><?php echo $this->playlist_column_names_titles[ 'time' ]; ?>:</span>
				<input type="text"
							 class="war_sdy_pl_txt_input"
							 readonly
			...
			<div class="war_sdy_pl_label_field_container">
				<span class="war_sdy_pl_label"><?php echo $this->playlist_column_names_titles[ 'id' ]; ?>:</span>
				<input type="text"
							 class="war_sdy_pl_txt_input"
							 readonly
		...
		<div style="margin-top: 5px;">
			<div class="war_sdy_pl_label_field_container_full_width">
				<div class="war_sdy_pl_label"><?php echo $this->playlist_column_names_titles[ 'title' ]; ?>:</div>
				<input  type="text"
				        class="war_sdy_pl_txt_input"
					    id="war_sdy_pl_audio_title" />
			</div>
			<div class="war_sdy_pl_label_field_container_full_width">
				<div   class="war_sdy_pl_label"><?php echo $this->playlist_column_names_titles[ 'artist' ]; ?>:</div>
				<input  type="text"
					    class="war_sdy_pl_txt_input"
				        id="war_sdy_pl_audio_artist" />
			</div>
			<div class="war_sdy_pl_label_field_container_full_width">
				<div class="war_sdy_pl_label"><?php echo $this->playlist_column_names_titles[ 'composer' ]; ?>:</div>
				<input  type="text"
					    class="war_sdy_pl_txt_input"
		...
		?>
            <div>
                ...
                <ul class="war_sdy_pl_back_end_playlist">
                    <li class="war_back_end_soundtrack_row_header"><div class="war_back_end_soundtrack_index">#</div><div class="war_back_end_soundtrack_title"><?php echo $this->playlist_column_names_titles[ 'title' ]; ?></div><div class="war_back_end_soundtrack_artist"><?php echo $this->playlist_column_names_titles[ 'artist' ]; ?></div><div class="war_back_end_soundtrack_composer"><?php echo $this->playlist_column_names_titles[ 'composer' ]; ?></div><div class="war_back_end_soundtrack_time"><?php echo $this->playlist_column_names_titles[ 'time' ]; ?></div><div class="war_back_end_soundtrack_id"><?php echo $this->playlist_column_names_titles[ 'id' ]; ?></div></li>
                </ul>
	...
	?>
        <div style="width: <?php echo $is_meta_box ? 85 : 95; ?>%; margin: 28px auto 0 auto; text-align: left;">
            ...
            <?php else: ?>
                <div class="war_sdy_pl_soundtrack_button_container">
                    <button id="war_sdy_pl_button_soundtrack_default"
                            type="button"
